    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <NuxtLink to="/stock-produit" class="p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-left">
            <div class="flex items-center">
              <svg class="h-8 w-8 text-blue-600 dark:text-blue-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
              </svg>
              <div>
                <p class="font-medium text-gray-900 dark:text-white">Voir les produits</p>
                <p class="text-sm text-gray-500 dark:text-gray-400">Gérer le stock</p>
              </div>
            </div>
          </NuxtLink>
          
          <NuxtLink to="/facturation" class="p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-left">
            <div class="flex items-center">
              ...
              <div>
                <p class="font-medium text-gray-900 dark:text-white">Nouvelle vente</p>
                <p class="text-sm text-gray-500 dark:text-gray-400">Créer une facture</p>
              </div>
            </div>
          </NuxtLink>
          
          <NuxtLink to="/mouvements-stock" class="p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-left">
            <div class="flex items-center">
              ...
              <div>
                <p class="font-medium text-gray-900 dark:text-white">Mouvements</p>
                <p class="text-sm text-gray-500 dark:text-gray-400">Voir les mouvements</p>
              </div>
            </div>
          </NuxtLink>
          
          <NuxtLink to="/listes-factures" class="p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-left">
            <div class="flex items-center">
              ...
              <div>
                <p class="font-medium text-gray-900 dark:text-white">Factures</p>
                <p class="text-sm text-gray-500 dark:text-gray-400">Voir les factures</p>
              </div>
            </div>
          </NuxtLink>
        </div>
